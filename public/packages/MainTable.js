...
var __chunk_2 = require('./chunk-0d96860d.js');
  ...
  __chunk_3._createClass(MainTableComponent, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        refs: this.table
      }), !items.length && isLastPage && !isLoading && canDoRequest ? React__default.createElement("tr", {
        className: "no-border"
      }, React__default.createElement("td", {
        colSpan: colsCount
      }, React__default.createElement("span", {
...
__chunk_1._defineProperty(MainTableComponent, "propTypes", {
  url: __chunk_3.PropTypes.string.isRequired,
...
var filtersDataGetAction = function filtersDataGetAction(reducer, endpoint, query) {
  return crud.crud({
    endpoint: endpoint,
    query: query,
    crudTypes: {
...
var listGetAction = function listGetAction(reducer, endpoint) {
  return crud.crud({
    endpoint: endpoint,
    crudTypes: {
...
var mainTableReducer = function mainTableReducer() {
  ...
  if (SUCCESS_LIST_REGEXP.test(action.type)) {
    ...
    if (action.payload.status === 'OK') {
      ...
      if (_items3.length) {
        nextState[_reducer11].items = [].concat(__chunk_2._toConsumableArray(nextState[_reducer11].items), [_items3]);
      }
    } else {
      nextState[_reducer11].isLastPage = true;
      nextState[_reducer11].items = __chunk_2._toConsumableArray(nextState[_reducer11].items);
    }
  }
