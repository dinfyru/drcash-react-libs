...
var crud = (function (_ref) {
  var _ref$method = _ref.method,
      ...
      _ref$uploadFile = _ref.uploadFile,
      uploadFile = _ref$uploadFile === void 0 ? false : _ref$uploadFile,
  ...
  var disableFilters = meta.disableFilters,
      _meta$requiredFilters = meta.requiredFilters,
      requiredFilters = _meta$requiredFilters === void 0 ? [] : _meta$requiredFilters;
  ...
  var action = __chunk_1._defineProperty({
    ...
    types: [{
      ...
      meta: function meta(actionFailure, state, res) {
        if (res) {
  ...
  if (!uploadFile) {
    ...
    action[RSAA].headers = _objectSpread({}, headers);
  }
    ...
    return function (action) {
      ...
      if (/.*_SUCCESS$/gi.test(action.type)) {
        ...
        if (cloneAction.meta && cloneAction.meta.validStatuses && cloneAction.payload) {
          ...
          if (ignoreStatuses.indexOf(status) < 0 && validStatuses.indexOf(status) < 0) {
